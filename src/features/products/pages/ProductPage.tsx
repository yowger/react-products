...
function ProductList({ products }: ProductListProps) {
    return (
        <div className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-10 gap-y-16">
...
function ProductCard(props: ProductProps) {
    ...
    return (
        <div className="rounded-md cursor-pointer p-4 hover:shadow-lg transition-shadow duration-500">
            <img
                src={product.image}
                alt={product.name}
